...
export default function NavBar() {
    ...
    return (
        <nav className="mb-2 flex items-center justify-between rounded-2xl border border-white/50 bg-white/60 px-2 md:px-4 py-2 md:py-3 shadow-sm backdrop-blur-md relative z-50">
